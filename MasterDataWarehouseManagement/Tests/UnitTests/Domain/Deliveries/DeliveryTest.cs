...
namespace Tests.UnitTests.Domain.Deliveries{
    ...
    public class DeliveryTest
    {
        ...
        private readonly MDWM.Domain.Deliveries.Delivery _delivery = 
            new MDWM.Domain.Deliveries.Delivery("idtest",new DateTime(2022,10,20),1,"waridtest",10,10);

        [Fact(DisplayName = "Sucess")]
        public void DeliveryCreatedSuccessfully()
        {
            Assert.NotNull(new MDWM.Domain.Deliveries.Delivery("idtest",new DateTime(2022,10,20),1,"waridtest",10,10));
        }
